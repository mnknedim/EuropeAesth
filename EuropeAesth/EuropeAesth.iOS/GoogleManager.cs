...
namespace EuropeAesth.iOS
{
	...
	{
		private Action<Model.GoogleUser, string> _onLoginComplete;
		...
		public void Login(Action<Model.GoogleUser, string> OnLoginComplete)
		{
		...
		public void DidSignIn(SignIn signIn, Google.SignIn.GoogleUser user, NSError error)
		{
			...
			if (user != null && error == null)
				_onLoginComplete?.Invoke(new Model.GoogleUser()
				{
